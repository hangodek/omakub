...
cp ~/.local/share/omakora/configs/alacritty.toml ~/.config/alacritty/alacritty.toml
cp ~/.local/share/omakora/themes/tokyo-night/alacritty.toml ~/.config/alacritty/theme.toml
cp ~/.local/share/omakora/configs/alacritty/fonts/CaskaydiaMono.toml ~/.config/alacritty/font.toml
cp ~/.local/share/omakora/configs/alacritty/font-size.toml ~/.config/alacritty/font-size.toml
